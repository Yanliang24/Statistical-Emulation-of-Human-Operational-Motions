...
%% Compute ISTVF of the Original Data
...
%% Compute ISTVF of the Noisy Data
...
% Reconstruction via MPCA and ISTVF
...
% Reconstruction of the Original Data via AE+FPCA and ISTVF
% FPCA reconstruction
for m = 1:M
    for k = 1:D1
        RS = Sf_AE(m,:,k);
...
% Reconstruction of the Original Data via VAE+FPCA and ISTVF
% FPCA reconstruction
for m = 1:M
    for k = 1:D1
        RS = Sf_VAE(m,:,k);
